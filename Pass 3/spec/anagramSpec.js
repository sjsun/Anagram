describe("anagram unscrambler", function () {
    ...
    */
    it("should give all possible suggestions", function() {
        expect(unscrambler.unscrambleAll("appl")).toEqual({"e":["apple"]});
        expect(unscrambler.unscrambleAll("doo")).toEqual({"r":["door","odor"]});
        expect(unscrambler.unscrambleAll("hell")).toEqual({"o":["hello"]});
    });
});
